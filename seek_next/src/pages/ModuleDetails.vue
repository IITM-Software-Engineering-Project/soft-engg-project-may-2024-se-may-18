          ...
          <v-row justify="center">
            <v-col cols="12" md="8">
              <v-card>
                ...
                <v-list two-line>
                  <v-list-item v-for="lecture in lectures" :key="lecture.title" class="mt-3">
                    <v-row>
                      <v-col>
                ...
                <v-list two-line>
                  <v-list-item v-for="assignment in assignments" :key="assignment.title" class="mt-3">
                    <v-row>
                      <v-col>
...
export default defineComponent({
  ...
  data() {
    return {
      moduleTitle: '',
      lectures: [] as Array<{ title: string; url: string; transcript: string }>,
      assignments: [] as Array<{
        title: string;
        description: string;
        type: string;
        due_date: string;
        questions: Array<{ question: string; answer_choices: any; answer: string; image: string | null }>;
      }>,
    };
  },
  setup() {
